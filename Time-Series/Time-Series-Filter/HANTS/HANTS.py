...
# https://github.com/pckujawa/harmonic_analysis_of_time_series/blob/master/hants/__init__.py
...
if __name__ == '__main__':
    y = array_in(1)
    y_Lo = HANTS(sample_count=26, inputs=y, frequencies_considered_count=3, outliers_to_reject='Lo').flatten()
    y_Hi = HANTS(sample_count=26, inputs=y, frequencies_considered_count=3, outliers_to_reject='Hi').flatten()
    y_None = HANTS(sample_count=26, inputs=y, frequencies_considered_count=3, outliers_to_reject='None').flatten()
